...
def generate_launch_description():
    ...
    gz_ros2_bridge = Node(
            ...
            arguments=[
                ...
                "/rgb_camera/image_raw@sensor_msgs/msg/Image[gz.msgs.Image",       # Remap image_raw topic
                "/rgb_camera/camera_info@sensor_msgs/msg/CameraInfo[gz.msgs.CameraInfo",     # Remap camera_info topic
            ]
        )
